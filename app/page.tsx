    ...
    <main className="min-h-screen overflow-x-hidden bg-gray-50 dark:bg-gray-950">
      ...
      <section className="px-5 py-16 text-center sm:px-6 sm:py-20 md:py-24">
        <div className="mx-auto max-w-3xl">
          <p className="text-xs font-semibold uppercase tracking-widest text-gray-500 dark:text-gray-400 sm:text-sm">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-gray-600 dark:text-gray-300 sm:text-lg sm:leading-8">
          ...
          <a
            href="#blogs"
            className="mt-7 inline-block rounded-full bg-gray-900 px-6 py-3 text-sm font-semibold text-white transition hover:bg-gray-700 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-200 sm:px-7 sm:text-base"
          >
            Explore Articles
          </a>
        </div>
